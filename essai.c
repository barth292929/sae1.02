...
int  trajOpti(tPlateau plateau, int lesX[], int lesY[], int nb_pomme, char direction);
...
// portail du 		HAUT 			  DROITE			  BAS				GAUCHE
int tp_x[] = {LARGEUR_PLATEAU/2, LARGEUR_PLATEAU  , LARGEUR_PLATEAU/2, 		   1		};
int tp_y[] = {		  1 	   , HAUTEUR_PLATEAU/2, HAUTEUR_PLATEAU  , HAUTEUR_PLATEAU/2};
...
int trajOpti(tPlateau plateau, int lesX[], int lesY[], int nb_pomme, char direction){
	...
	if (Distance_pomme<=Distance_gauche && Distance_pomme<=Distance_droite && Distance_pomme<=Distance_haut && Distance_pomme<=Distance_bas)
	{
		...
		if (Distance_pomme>=Distance_droite && Distance_pomme<=Distance_haut && Distance_pomme<=Distance_bas){
			return 1;
		}
		
		else if (Distance_pomme>=Distance_gauche && Distance_pomme<=Distance_haut && Distance_pomme<=Distance_bas){
			return 3;
		}
